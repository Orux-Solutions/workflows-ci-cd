...
class TaxonomyEngine:
    """Motor de taxonomía dinámico cargado directamente desde documentaciones / orux-docs."""
    ...
    def _find_file(self, filename: str) -> Path | None:
        candidates = [
            ...
            ROOT / ".documentaciones" / "docs" / "modules-dynamic" / "taxonomy" / filename,
            ROOT / ".orux-docs" / "docs" / "modules-dynamic" / "taxonomy" / filename,
            ROOT.parent / "documentaciones" / "docs" / "modules-dynamic" / "taxonomy" / filename,
            ROOT.parent / "orux-docs" / "docs" / "modules-dynamic" / "taxonomy" / filename,
            Path(__file__).resolve().parent.parent.parent / "documentaciones" / "docs" / "modules-dynamic" / "taxonomy" / filename,
...
def main() -> int:
    ...
    print("::error::Se detectaron God Services violando la Regla 6 y 7 de documentaciones.")
    print("=" * 80 + "\n")
    return 1
